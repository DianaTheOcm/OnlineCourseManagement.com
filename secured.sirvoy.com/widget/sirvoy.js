    ...
    function onMessage(event) {
        ...
        if (msg.event === 'gallery_init') {
            ...
            if (loadGallery !== false) {
                ...
                loadSirvoyStylesheet(["https:\/\/cdn.sirvoy.com\/build-cdn\/apps\/engine\/gallery.c1d03d41.css"]);
                // load javascript for gallery
                loadSirvoyJavascript(["https:\/\/cdn.sirvoy.com\/build-cdn\/runtime.32aceb44.js","https:\/\/cdn.sirvoy.com\/build-cdn\/apps\/engine\/gallery.27d5dc01.js"]);
                return;
            }
    ...
    function main() {
        ...
        for (var i = 0; i < foundScriptTags.length; i++) {
            ...
            if (foundScriptTag.src === thisRequestUri && processedScripts.indexOf(foundScriptTag) < 0) {
                ...
                loadSirvoyStylesheet(["https:\/\/cdn.sirvoy.com\/build-cdn\/css\/widget-book.deabaa79.css"]);
